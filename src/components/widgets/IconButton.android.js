  ...
  render() {
    ...
    return (
        <View style={[styles.container]} >
            ...
            {this.props.sign && <View style={[Env.style.fxCenter,{width:Env.font.base * 22,height:Env.font.base * 22,borderRadius:Env.font.base * 20,backgroundColor:'red',position:'absolute',top:0,right:Env.font.base * -16}]}>
