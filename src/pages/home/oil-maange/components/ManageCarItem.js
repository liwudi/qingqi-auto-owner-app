                ...
                <View style={estyle.fx1}>
                    ...
                    <View style={[estyle.fxRow,estyle.paddingTop]}>
                        ...
                        <View style={[estyle.fxRow,estyle.fxRowCenter,{marginLeft:5 * basefont}]}>
                            <Text style={[estyle.note,{fontSize:22 * basefont}]}>当日油耗：</Text><Text style={[{fontSize:Env.font.mini,color: Env.color.main}]}>{(list.avgOilwear * list.mileage / 100).toFixed(2) || 0}L</Text>
                        </View>
                        <View style={[estyle.fxRow,estyle.fxRowCenter,{marginLeft:5 * basefont}]}>
