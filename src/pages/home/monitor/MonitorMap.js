...
export default class MonitorMap extends Component {
    ...
    queryCarPolymerize() {
        /*        leftLongitude	Float	是		左下角经度	左下角经度
         leftLatitude	Float	是		左下角纬度	左下角纬度
         rightLongitude	Float	是		右上角经度	右上角经度
         rightLatitude	Float	是		右上角纬度	右上角纬度
         zoom*/
        queryCarPolymerize({
    ...
    addCar() {
        /*  let pt = this.MPoint([115.95380, 28.68291]);
         if(!this.carId) {
    ...
    render() {
        return (
            <View style={[estyle.containerBackgroundColor, estyle.fx1]}>
                ...
                <MapbarMap zoom={this.zoom} initMap={(instance)=> {this.initMap(instance);}} legend={this.renderLegend()}/>
            </View>
        )
    }
}
