                        ...
                        <LabelInput
                            ...
                            leftView={
                                <View style={[{width:200*basefont},estyle.fxRow]}>
                                    ...
                                    <TouchableOpacity style={[estyle.marginLeft,estyle.fxCenter,estyle.fxRow]} onPress={this.open.bind(this)}>
                                        <Text style={[estyle.text,{marginRight:10*basefont}]}>{this.state.pro}</Text>
                                        <IconCaretDown />
                                    </TouchableOpacity>
                                </View>
                            }
