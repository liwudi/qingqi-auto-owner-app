            ...
            <View style={[estyle.containerBackgroundColor, estyle.fx1]}>
                ...
                <View style={[estyle.marginTop,estyle.fx1,estyle.fxRowCenter]}>
                    ...
                    <View style={[styles.imgBox]}>
                        ...
                        }
                        {
                            this.props.data.idCardValidStatus !== 4 ?
                                <TouchableOpacity style={[styles.camera,estyle.fx1,estyle.fxCenter]} onPress={ ()=>{ this.openMenu(1)} }>
                    ...
                    <View style={[styles.imgBox]}>
                        ...
                        {
                            this.props.data.idCardValidStatus !== 4 ?
                                <TouchableOpacity style={[styles.camera,estyle.fx1,estyle.fxCenter]} onPress={ ()=>{ this.openMenu(2)} }>
                                    <Image source={camera} style={[{width: 120 * basefont,height: 120 * basefont }]} />
                                </TouchableOpacity>: null
                        }
                    </View>
